...
130 IFDES$="G"THENPRINT"{home}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}PER GLI ALTRI"
131 IFDES$="G"THENGOTO135
132 PRINT"{home}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}PER LE ALTRE"
135 IFDES$="G"THENPRINT"{home}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}GIOCATORI{wht}"
140 IFDES$="G"THENGOTO150
145 PRINT"{home}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}{rght}SQUADRE{wht}"
150 IFDES$="SCE"THENPRINT"{home}          SCEGLI LA TUA SQUADRA"
155 IFDES$="SQ"THENPRINT"{home}QUALE NOME DI SQUADRA VUOI CAMBIARE ?"
160 IFDES$="GIO"THENPRINT"{home}QUALE NOME DI GIOCATORE VUOI CAMBIARE ?"
170 RETURN
200 GG=0:PRINT"{clr}"
230 PRINTUNO$
231 PRINTDUE$
...
330 GOTO320
340 PRINTTRE$
345 PRINT"*-INFORTUNATO  S-PANCHINARO  G-TITOLARE":RETURN
...
595 I=0:W=150000:Y=0:Z=0:K=15:R=20:B1=1
600 C$="DCA* SG":G(0)=-1
605 FORHZ=1TO16:W(HZ)=0:NEXT
610 FORHZ=1TO24:READB$(HZ):NEXT:PT$="   "
620 DATABORDON,TANCREDI,NELA,CABRINI,VIERCHOWOD,JUNIOR,PASSARELLA,TRICELLA
630 DATAWILKINS,ZICO,SOUNESS,BAGNI,MARADONA,PLATINI,DOSSENA,BRADY
640 DATAALTOBELLI,RUMENIGGE,GIORDANO,ROSSI,VIRDIS,GALDERISI,HATELEY,SERENA
650 N=4:FORHZ=1TO64:READA$(HZ):NEXT
660 DATAASCOLI,ATALANTA,AVELLINO,COMO,CREMONESE,FIORENTINA,INTER,JUVENTUS
670 DATALAZIO,MILAN,NAPOLI,ROMA,SAMPDORIA,TORINO,UDINESE,VERONA
680 DATAAREZZO,TRENTO,CAGLIARI,CATANIA,CESENA,EMPOLI,GENOA,LECCE,MONZA,PADOVA
690 DATAPERUGIA,CATANZARO,PISA,TARANTO,TRIESTINA,VARESE
700 DATABOLOGNA,CAMPOBASSO,PARMA,PIACENZA,VICENZA,RIMINI,PISTOIESE,BRESCIA
710 DATAMODENA,SANREMESE,SPAL,CARRARESE,ANCONA,LIVORNO,FOGGIA,PALERMO
720 DATAPESCARA,MESSINA,CAVESE,REGGINA,FRANCAVILLA,CASARANO,NOCERINA,FANO
730 DATAMANTOVA,SIRACUSA,SAVONA,SIENA,VENEZIA,ALESSANDRIA,POTENZA,BRINDISI
735 SR$(4)="C2":SR$(3)="C1":SR$(2)="B":SR$(1)="A"
...
900 PRINT"{$dd}{blu}1{blk} {$dd} {wht}PER VENDERE O LISTARE GIOCATORI  {blk}{$dd}"PIQ$
910 PRINT"{$dd}{blu}2{blk} {$dd} {wht}PER OTTENERE UN PRESTITO         {blk}{$dd}"PIQ$
920 PRINT"{$dd}{blu}3{blk} {$dd} {wht}PER STAMPARE LA CLASSIFICA       {blk}{$dd}"PIQ$
930 PRINT"{$dd}{blu}4{blk} {$dd} {wht}PER VEDERE LA CONDIZIONE         {blk}{$dd}"PIQ$
953 PRINT"{$dd}{blu}5{blk} {$dd} {wht}PER CAMBIARE IL NOME ALLE SQUADRE{blk}{$dd}"PIQ$
955 PRINT"{$dd}{blu}6{blk} {$dd} {wht}PER CAMBIARE IL NOME AI GIOCATORI{blk}{$dd}"PIQ$
960 PRINT"{$dd}{blu}G{blk} {$dd} {wht}PER GIOCARE LA PARTITA           {blk}{$dd}"PIQ$
965 PRINT"{$dd}{blu}R{blk} {$dd} {wht}PER RICOMINCIARE DA ZERO         {blk}{$dd}"
966 PRINT"{$dd}  {$dd} {wht}CON UNA SQUADRA DIVERSA          {blk}{$dd}"
...
1230 PRINT5000*(5-N)+5000*A(XZ);TAB(35)MID$(C$,(C(XZ)+3),1):
...
1300 PRINT"{home}{down}{rght}{rght}VENDI QUALCUNO ? , SE NO PREMI SPACE"
...
1340 IFC(UZ)=0THENPRINTRIG$"{rght}{rght}{rght}{rght}NON HAI "B$(UZ)" NELLA TUA SQUADRA{down}{down}{down}":GOTO1430
1350 IFC(UZ)=1THENPRINTRIG$"{rght}{rght}{rght}{rght}NON CI SONO OFFERTE PER "B$(UZ)"{down}{down}{down}":GOTO1430
1360 PZ=5000*(5-N)+5000*A(UZ):PZ=INT(PZ+(RND(1)*(PZ/10))-(RND(1)*(PZ/10)))
1365 PRINTRIG$
1370 PRINT"{rght}{rght}ACCETTI "PZ" DAL "A$(INT(RND(1)*64)+1)
1380 PRINT"{rght}{rght}PER IL TUO GIOCATORE "B$(UZ)" ?"
1390 PRINT"{rght}{rght}PREMERE  S  OPPURE  N  "
1400 GETA$:IFA$<>"N"ANDA$<>"S"THEN1400
1410 IFA$="S"THENW=W+PZ:C(UZ)=0:PRINT"{rght}{rght}"B$(UZ)" E' STATO VENDUTO.":GOTO1430
1420 C(UZ)=INT(RND(1)*2)+1:PRINT"{rght}{rght}"B$(UZ)" E' ANCORA UN TUO GIOCATORE."
1430 PRINT"{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}  SPACE  PER ANDARE AVANTI             "
1440 GETA$:IFA$<>" "THEN1440
1450 RETURN
1460 REM PRESTITO
1465 GOSUB200
1470 PRINT"{home}":PRINT"{rght}{rght}{rght}        BANCA DELLO SPORT"
1475 PRINT"{down}{down}{rght}{rght}{rght}HAI UN TOTALE DI \ "W
1480 PRINT"{down}{down}{rght}{rght}{rght} E UN DEBITO DI \ "Y
1490 PRINT"{down}{down}{rght}{rght}{rght}QUANTO VUOI PRENDERE IN PRESTITO{down}{down}"
1500 INPUTXZ:IFXZ=0THENRETURN
1510 IFXZ+Y>100000*(5-N)THENPRINT"{down}{down}{rght}{rght}{rght}NON E' POSSIBILE OTTENERE UN"
1515 IFXZ+Y>100000*(5-N)THENPRINT"{rght}{rght}{rght}UN PRESTITO DI \ "XZ+Y
1520 IFXZ+Y>100000*(5-N)THENPRINT"{rght}{rght}{rght}IL MASSIMO DEBITO IN SERIE "SR$(N)
1525 IFXZ+Y>100000*(5-N)THENPRINT"{rght}{rght}{rght}E' \ "100000*(5-N)
1530 IFXZ+Y>100000*(5-N)THENGOTO1590
1540 Y=Y+XZ*1.2:Z=Y/20:W=W+XZ
1550 PRINT"{down}{down}{rght}{rght}{rght}E' POSSIBILE OTTENERE"
1555 PRINT"{rght}{rght}{rght}UN PRESTITO DI \ "XZ
1560 PRINT"{rght}{rght}{rght}AMMONTARE DEL DEBITO \ "Y
1570 PRINT"{rght}{rght}{rght}INTERESSE SETTIMANALE \ "Z
1580 PRINT"{rght}{rght}{rght}HAI \ "W
1590 PRINT"{down}{down}  PREMI SPACE "
1600 GETA$:IFA$<>" "THEN1600
1610 RETURN
1620 GOSUB430:REM CLASSIFICA
1630 IFI=0THENGOSUB20810:RETURN:REM NO PARTITE
1640 PRINT"{home}{down}";"{rght}{rght}     SQUADRA"TAB(21)"F"TAB(25)"S"TAB(29)"PT.";
1650 PRINTTAB(35)"DR{down}"
...
1710 NEXT
1720 PRINT"{down}{rght}{rght}LA TUA POSIZIONE E' "V(1)"'"
1723 IF I=1THENPRINT"{rght}{rght}DOPO "I" PARTITA ":GOTO1730
1725 PRINT"{rght}{rght}DOPO "I" PARTITE "
1730 PRINT"{rght}{rght}SPACE  PER ANDARE AVANTI"
...
1790 PRINT"{home}{down}{rght}{rght}{rght}SOCIETA'  "A$(49)
1800 PRINT"{down}{down}{rght}{rght}{rght}LIVELLO DIREZIONE : "PZ
1810 PRINT"{down}{down}{rght}{rght}{rght}CAMPIONATI GIOCATI : "B1
1820 PRINT"{down}{down}{rght}{rght}{rght}MORALE DELLA SQUADRA : "K
1830 PRINT"{down}{down}{rght}{rght}{rght}POSIZIONE : "V(1)"'  IN SERIE "SR$(N)"."
1840 PRINT"{down}{down}{down}{rght}{rght}{rght}SOLDI IN CASSA : "W
1850 PRINT"{down}{rght}{rght}{rght}   DEBITI      : "Z
1860 PRINT"{down}{down}{down}{rght}{rght}{rght}PREMI SPACE"
...
2020 PRINT"{rvon} {rvof}{$dd}{wht}FOOTBALL  MANAGER  C-64{yel}{$dd}{rvon} {rvof}"
...
2683 PRINT"{down}{down}  SCRIVI IL NOME"
...
2720 PRINT"{down}{down}{down}{down}PREMI SPACE"
...
2836 PRINT"{down}{down}  SCRIVI IL NOME"
...
2870 PRINT"{down}{down}{down}PREMI SPACE"
...
3020 GOSUB350:PRINT"{home}{down}{rght}{rght} PRONTO A INIZIARE LA PARTITA ? "
3025 PRINT"{down}{down}{rght}{rght} GIOCHI NEL CAMPIONATO":PRINT"{down}{rght}{rght} DI SERIE "SR$(N)
3060 PRINT"{down}{rght}{rght}{yel} "D$(1),"{wht}CONTRO{blu}",D$(2)"{wht}"
3100 PRINT"{down}{rght}{rght}    STAI GIOCANDO ";
3110 IFPZ=2THENPRINT"IN CASA":ZIO$="CASA":GOTO3122
3120 PRINT"FUORI CASA":ZIO$="FUORI CASA"
3122 PRINT"{down}{down}{down}{rght}{rght}{rght}{rght}{rght}         PREMI SPACE"
3125 IFI>0ANDPZ=2THENPRINT"{down}{down}{down}{down}{rght}{rght}{blu}"D$(2);"{wht}  E' "V(A1)" IN CLASSIFICA"
3127 IFI>0ANDPZ<>2THENPRINT"{down}{down}{down}{down}{rght}{rght}{yel}"D$(1);"{wht}  E' "V(A1)" IN CLASSIFICA"
...
3290 PRINT"{down}{down}{rght}{rght}ENERGIA"TAB(15)D(1)TAB(25)D(8)
3300 PRINT"{rght}{rght}MORALE "TAB(15)D(2)TAB(25)D(9)
3310 PRINT"{rght}{rght}DIFESA "TAB(15)D(3)TAB(25)D(10)
3320 PRINT"{rght}{rght}CENTROCAMPO"TAB(15)D(4)TAB(25)D(11)
3330 PRINT"{rght}{rght}ATTACCO"TAB(15)D(5)TAB(25)D(12)
3340 PRINT"{down}{down}{down}{down}{rght}{rght}HAI IN SQUADRA "XZ" GIOCATORI."
3350 IFUZ=0THENPRINT"{down}{rght}{rght}MA NON IL SOSTITUTO ":GOTO3370
3360 PRINT"{down}{rght}{rght}E ANCHE IL SOSTITUTO "
3370 PRINT"{down}{down}{rght}{rght}   C     PER CAMBIARE LA FORMAZIONE"
3380 PRINT"{down}{rght}{rght} SPACE   PER GIOCARE LA PARTITA"
3390 GETA$:IFA$="C"THENGOSUB25070:GOTO3270:REM CAMBIO
3400 IFA$<>" "THEN3390
3410 A$="PRIMO TEMPO":PRINT"{clr}":H(1)=0:H(2)=0
...
3460 A$="SECONDO TEMPO":PRINT"{clr}":GOSUB20220
...
3530 IFU1>P1THENG(1)=G(1)+2:GOTO3550
3540 G(A1)=G(A1)+2
3550 GOTO3650
3630 PRINT"SPACE  PER ANDARE AVANTI"
3640 GETA$:IFA$<>" "THEN3640
3650 RETURN
3660 REM GUADAGNI
3670 XZ=0:FORPZ=1TO24:IFC(PZ)>0THENXZ=XZ+70+(5-N)*10
3680 NEXT
3685 HZ=XZ+500*(5-N)+Z
3690 GOSUB 350:PRINT"{home}{down}{rght}{rght}BILANCIO SETTIMANALE :"
3700 PRINT"{down}{down}{rght}{rght}AFFITTO CAMPO   :"XZ
3710 PRINT"{rght}{rght}SPESE VARIE     :"500*(5-N)
3720 PRINT"{rght}{rght}INTERESSI DEBITO:"Z
3730 PRINT"{rght}{rght}TOTALE USCITE   :"HZ
3740 PRINT"{rght}{rght}INCASSO PARTITA :"A2
3750 PRINT"{rght}{rght}BILANCIO SETTIMANALE :";
3760 PRINTA2-HZ:W=W+A2-HZ
3770 IFW<0THENPRINT"{down}{down}{down}{rght}{rght}IL DEBITO VIENE AUMENTATO"
3775 IFW<0THENPRINT"{down}{rght}{rght}PER PAGARE L'AFFITTO DEL CAMPO{up}"
3780 IFW<0THENW=W+1000:Y=Y+1200:Z=Y/20:GOTO3780
3790 Y=Y-Z:IFY=0THENZ=0
3800 IFW<0THENPRINT"{down}{down}{rght}{rght}HAI \ "W:GOTO3805
3802 PRINT"{down}{down}{down}{rght}{rght}HAI \ "W
3805 PRINT"{rght}{rght}E UN DEBITO DI \ "Y
3810 PRINT"{rght}{rght}SPACE  PER ANDARE AVANTI"
...
3870 PRINT"{home}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{rght}{rght}_   PER CAMBIARE GIOCATORE"
3872 PRINT"{rght}{rght}^   PER NON COMPRARE NESSUNO"
3875 PRINT"{home}{down}{rght}{rght}{rght}{rght}{rght}       CALCIO  MERCATO "
3880 PRINT"{down}{down}{rght}{rght}TU HAI \ "W
3900 XZ=5000*(5-N)+5000*A(PZ)
3910 PRINT"{down}{down}{rght}{rght}"MID$(C$,INT((PZ-1)/8)+1,1)TAB(10)B$(PZ)"           "
3920 PRINT"{down}{down}{rght}{rght}STILE "A(PZ)TAB(10)"{blk}:{wht}POTENZA "B(PZ)TAB(22)"{blk}:{wht}VALORE "XZ
3930 PRINT"{down}{down}{down}{down}{down}{rght}{rght}QUAL'E'LA TUA OFFERTA"
...
3990 IFHZ<UZTHENPRINT"{rght}{rght}LA TUA OFFERTA PER "B$(PZ)
3995 IFHZ<UZTHENPRINT"{rght}{rght}E' STATA RIFIUTATA{down}":GOTO4030
4000 PRINT"{rght}{rght}LA TUA OFFERTA PER "B$(PZ):PRINT"{rght}{rght}E' STATA ACCETTATA"
4010 PRINT"{rght}{rght}ORA "B$(PZ)" E' UN TUO GIOCATORE"
4020 C(PZ)=2:W=W-HZ
4030 PRINT"{rght}{rght}PREMI SPACE"
4040 GETA$:IFA$=" "ORA$="_"THEN4045
4042 GOTO 4040
4045 IF A$ ="_"THENGOSUB500:GOTO3845
4050 RETURN
4060 GOSUB430:REM FINE CAMPIONATO
4070 PRINT"{home}{down}{rght}{rght}            FINE CAMPIONATO    "
4080 PRINT"{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{rght}{rght}SPACE  PER LA CLASSIFICA FINALE"
4090 GETA$:IFA$<>" "THEN4090
4100 GOSUB1620
4110 GOSUB430:PRINT"{home}{down}{down}":R=R+(8-V(1))*5+T*5:B1=B1+1:FORPZ=1TO16
4115 IFV(PZ)>13ANDN<>4THENPRINT"{rght}{rght}RETROCESSIONE PER ";A$(PZ+(N-1)*16):GOSUB25350
4120 IFV(PZ)<4ANDN<>1THENPRINT"{rght}{rght}PROMOZIONE PER ";A$(PZ+(N-1)*16):GOSUB25320
4130 NEXT
4140 IFN=1THENGOSUB25380
4150 PRINT"{rght}{rght}NUOVO CAMPIONATO "
4160 IFV(1)<4ANDN<>1THENN=N-1:GOTO4180
4170 IFV(1)>13ANDN<>4THENN=N+1
4180 PRINT"{rght}{rght}SERIE "SR$(N):QZ=(N-1)*16+1
4190 FORPZ=1TO24
...
4260 J(1)=6:K=15:I=0
4270 PRINT"{home}{rght}{rght}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}  G  PER GIOCARE IL NUOVO CAMPIONATO"
...
20230 PRINT"{home}{down}"TAB(8)"PARTITA IN SVOLGIMENTO :"
...
20350 PRINT"{home}{down}"TAB(7)"IL PRIMO TEMPO E' FINITO"
20360 PRINT"{down}{down}{down}{rght}{rght}IL RISULTATO E' :"
20370 PRINT"{down}{down}{down}{rght}{rght}"D$(1)"  "H(1)"       "D$(2)"  "H(2)
20380 PRINT"{down}{down}{down}{down}{rght}{rght}  C    PER CAMBIARE LA FORMAZIONE"
20390 PRINT"{down}{down}{down}{down}{rght}{rght}SPACE  PER GIOCARE SENZA CAMBIAMENTI"
20400 GETA$:IFA$=" "THENRETURN
20405 IFA$<>"C"THEN20400
20410 GOSUB300:GOSUB1150
20420 PRINT"{home}{down}{rght}{rght}CHI DEVE LASCIARE IL CAPO DI GIOCO ?"
20425 PRINT"{down}{rght}{rght}SPACE PER GIOCARE SENZA SOSTITUZIONI"
...
20490 PRINT"{home}{down}"TAB(7)"RISULTATO FINALE :"
...
20550 A2=(17-V(1))*INT(RND(1)*400)+500*(5-N)
20560 PRINT"{rght}{rght}INCASSO :"A2:K=INT(K)
20570 IFL=1THENC$(I+1)=STR$(SZ)+","+STR$(A3)+"."+STR$(H(A3))+STR$(H(A4))
20580 RETURN
20590 REM RISULTATI
20595 PRINT"{rght}{rght}ECCO GLI ALTRI RISULTATI{down}{down}"
...
20650 V(HZ)=1
20660 IFG(XZ)<I*1.5THENSZ=INT(RND(1)*2+I):GOTO20680
20670 SZ=G(XZ)
20680 P1=INT(RND(1)*(SZ/I+3))
20690 IFG(HZ)<I*1.5THENUZ=INT(RND(1)*2*I):GOTO20710
20700 UZ=G(HZ)
...
20740 IFP1>U1THENG(XZ)=G(XZ)+2:GOTO20770
20750 IFU1>P1THENG(HZ)=G(HZ)+2:GOTO20770
20760 G(XZ)=G(XZ)+1:G(HZ)=G(HZ)+1
20770 PRINT:NEXT
20780 PRINT"{rght}{rght}SPACE  PER  ANDARE  AVANTI"
20790 GETA$:IFA$<>" "THEN20790
20800 RETURN
20810 PRINT"{home}{down}{down}{down}{rght}{rght}IN QUESTO CAMPIONATO NON SONO STATE"
20820 PRINT"{rght}{rght}ANCORA GIOCATE PARTITE !"
20830 PRINT"{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{rght}{rght}SPACE  PER ANDARE AVANTI"
20840 GETA$:IFA$<>" "THEN20840
20850 RETURN
20860 REM NON PIU' GIOC.
20865 PRINT"{home}{down}{rght}{rght}        CALCIO MERCATO           {down}{down}"
20870 PRINT"{rght}{rght}NON PUOI AVERE PIU' DI 16 GIOCATORI "
20880 PRINT"{down}{down}{rght}{rght}NELLA TUA SQUADRA           "
20885 PRINT"{down}{down}{rght}{rght}FINCHE' NON NE VENDERAI ALMENO UNO  "
20887 PRINT"{down}{down}  NON NE POTRAI PIU' COMPRARE."
20890 PRINT"{down}{down}{rght}{rght}          PREMI SPACE"
...
25090 PRINT"{home}{down}{rght}{rght}IN SQUADRA CI SONO "UZ" GIOCATORI."
25100 IFPZ=1THENPRINT"{rght}{rght}E ANCHE IL SOSTITUTO.":GOTO25120
25110 PRINT"{rght}{rght}MA NON IL SOSTITUTO."
25120 IFUZ>11THEN25270
25130 PRINT"{rght}{rght}CHI VUOI METTERE IN SQUADRA ?"
25140 PRINT"{rght}{rght}SPACE PER ANDARE{$a0}AVANTI"
...
25192 PRINT"{home}{down}{rght}{rght}IN SQUADRA CI SONO "UZ" GIOCATORI."
25194 IFPZ=1THENPRINT"{rght}{rght}E ANCHE IL SOSTITUTO.":GOTO25200
25196 PRINT"{rght}{rght}MA NON IL SOSTITUTO."
25200 PRINT"{rght}{rght}IMMETTI IL SOSTITUTO
25205 PRINT"{rght}{rght}SPACE PER ANDARE AVANTI
...
25250 NEXT:C(HZ)=3
25260 GOTO25190
25270 PRINT"{rght}{rght}CHI VUOI LEVARE DALLA SQUADRA ?"
...
25370 RETURN
25380 REM SCUDETTO
25390 FORPZ=1TO16:IFV(PZ)=1THENPRINT"{rght}{rght}";A$(PZ+(N-1)*16)" E' CAMPIONE D'ITALIA !
25400 NEXT
25410 RETURN
...
46000 IF ZIO$="CASA"THEN NEL=2:RETURN
46010 IF ZIO$="FUORI CASA"THEN NEL=1:RETURN
46020 RETURN
46100 IF ZIO$="CASA"THEN NEL=1:RETURN
46110 IF ZIO$="FUORI CASA"THEN NEL=2:RETURN
46120 RETURN
